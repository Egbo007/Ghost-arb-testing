...
const FLASH_LOAN_PROTOCOL = process.env.FLASH_LOAN_PROTOCOL || 'AAVE';
...
async function main() {
  console.log('╔══════════════════════════════════════╗');
  console.log('║   Ghost Arb Monitor v1.9             ║');
  console.log('║   7-Bug Fix + Balancer Flash Fee     ║');
  console.log('╚══════════════════════════════════════╝');
  ...
  await sendTelegram(`🤖 <b>Ghost Arb Monitor v1.9 LIVE</b>
