...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// PAIRS TO WATCH
// DEBUG MODE: WETH/USDC only
// Reason: confirmed working in v4.1, easiest to verify.
// Once signals are accurate, uncomment pairs one by one.
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
const WATCH_PAIRS = [
  { name: 'WETH/USDC', tokenA: TOKENS.WETH, tokenB: TOKENS.USDC, minLiquidity: 10000 },

  // Uncomment one at a time after WETH/USDC is confirmed working:
...
async function main() {
  console.log('╔══════════════════════════════════════╗');
  console.log('║   Ghost Arb Monitor v4.2             ║');
  console.log('║   Active V3 Liquidity + 12 Pairs     ║');
  console.log('╚══════════════════════════════════════╝');
  ...
  await sendTelegram(`🤖 <b>Ghost Arb Monitor v4.2 LIVE</b>

✅ Active V3 liquidity (liquidity() not balanceOf)
✅ 12 pairs: 4 stables + cbETH + 3 BTC + 3 meme
✅ Accurate V3→V3, V2→V3, V3→V2, V2→V2 profit
